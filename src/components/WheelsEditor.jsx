...
function WheelsEditor() {
    ...
    if (selectedCar) {
      return selectedCar.carColorImage.map((car, index) => {
        return (
          ...
          >
            <img src={car} className="w-20 h-14 rounded-xl contain"></img>
          </button>
        );
      });
    }
  ...
  return (
    <div className="text-black px-4 md:px-0  w-11/12 md:w-10/12 w-full flex flex-col overflow-y-hidden overflow-x-hidden mx-auto">
      <div className="w-full flex flex-col xl:flex-row items-center md:items-center justify-between ">
        ...
        <div data-aos="fade-left" data-aos-once="true" className="w-full h-full flex flex-col md:ml-4 p-4 md:p-8 shadow-lg rounded-xl wheels-background mt-8 md:mt-0">
      ...
      <div data-aos="fade-up" data-aos-once="true" className="w-full p-4 md:p-8 shadow-lg rounded-xl wheels-background my-8">
